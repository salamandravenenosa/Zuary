    ...
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-12">
      ...
      <div className="p-8 rounded-xl border border-white/[0.08] bg-white/[0.02]">
        ...
        <p className="text-muted-foreground leading-relaxed mb-4">
          Acreditamos que toda clínica odontológica merece ter acesso profissional a métricas de marketing, sem precisar de um time de数据分析 dedicado. O Zuary traduz dados complexos em insights acionáveis que ajudam clínicas a crescer.
        </p>
